...
class ClientModel:
    ...
    def to_dict(client_data):
        ...
        return {
            ...
            'gender': client_data.get('gender'),  # male, female
    ...
    def from_dict(data):
        ...
        return {
            ...
            'citizenship_issued_date': data.get('citizenship_issued_date'),
            'citizenship_issued_office': data.get('citizenship_issued_office'),
            ...
            'company_reg_issued_date': data.get('company_reg_issued_date'),
            'company_reg_issued_office': data.get('company_reg_issued_office'),
